...
import trainee.spring.securityjwt.auth.ApplicationUserService;
import trainee.spring.securityjwt.jwt.JwtProvider;
import trainee.spring.securityjwt.jwt.JwtTokenVerifierFilter;
import trainee.spring.securityjwt.jwt.JwtUsernameAndPasswordAuthenticationFilter;

import static trainee.spring.securityjwt.config.ApplicationUserRole.MANAGER;
